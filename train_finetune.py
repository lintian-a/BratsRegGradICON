...
def train_two_stage(GPUS, ITERATIONS_PER_STEP):
    ...
    batch_function = BraTSDataset(BATCH_SIZE*GPUS, with_augment=False, cross_patient=False)
    ...
    net_2.regis_net.load_state_dict(torch.load("/playpen-raid2/lin.tian/projects/BratsRegGradICON/results/BraTSReg/gradicon_with_aug_cross_patient/debug/2nd_step/Step_2_final.trch", map_location="cpu"))
    ...
    #     torch.load(
    #         "/playpen-raid2/lin.tian/projects/BratsRegGradICON/results/BraTSReg/gradicon_finetune/on_crosspatient/debug/2nd_step/optimizer_weights_9900",
    #         map_location='cpu'
    #     )
    # )
